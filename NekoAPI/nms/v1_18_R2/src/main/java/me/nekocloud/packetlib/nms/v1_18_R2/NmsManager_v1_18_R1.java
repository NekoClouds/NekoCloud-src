package me.nekocloud.packetlib.nms.v1_18_R1;
...
public class NmsManager_v1_18_R1 implements NmsManager {
    ...
    public void sendMetaData(Player player, Entity entity) {
        ...
        net.minecraft.server.v1_18_R1.Entity handle = ((CraftEntity) entity).getHandle();
    ...
    public void sendGlowing(Player player, Entity who, boolean glow) {
        ...
        net.minecraft.server.v1_18_R1.Entity nmsEntity = ((CraftEntity) who).getHandle();
