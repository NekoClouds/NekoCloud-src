...
public class MultikeyCacheHashMap<V> extends LinkedHashMap<Class<?>, MultikeyCacheHashMap.GitCacheMap<MultikeyCacheHashMap.Entry<V>>>
    ...
    public MultikeyCacheHashMap(int duration, @NotNull TimeUnit timeUnit) {
    ...
    @Override
    public <T> V computeIfAbsent(Class<T> registerClass, T t, @NotNull Supplier<V> supplier) {
    ...
    public static class GMultiCacheType<V> extends GitCacheMap<Entry<V>> {
        ...
        @Override
        public void delete(@NotNull Entry<V> entry) {
