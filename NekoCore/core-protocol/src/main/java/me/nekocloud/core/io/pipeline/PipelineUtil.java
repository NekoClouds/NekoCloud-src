package me.nekocloud.core.io.pipeline;
...
import me.nekocloud.core.io.varint.VarIntPacketDecoder;
import me.nekocloud.core.io.varint.VarIntPacketEncoder;

@UtilityClass
public class PipelineUtil {

    private final int LOW_MARK = SystemPropertyUtil.getInt("me.nekocloud.core.low_mark", 2 << 18);
    private final int HIGH_MARK = SystemPropertyUtil.getInt("me.nekocloud.core.high_mark", 2 << 20);
    ...
    public void initPipeline(Channel ch) {
        ...
        //bossHandler.setHandler(null); //todo
