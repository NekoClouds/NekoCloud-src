#include <stdlib.h>
#include <zlib.h>
#include "me_nekocloud_core_io_compress_zlib_NativeCompressImpl.h"
...
void JNICALL Java_me_nekocloud_core_io_compress_zlib_NativeCompressImpl_initFields(JNIEnv* env, jclass clazz) {
...
void JNICALL Java_me_nekocloud_core_io_compress_zlib_NativeCompressImpl_reset(JNIEnv* env, jobject obj, jlong ctx, jboolean compress) {
...
void JNICALL Java_me_nekocloud_core_io_compress_zlib_NativeCompressImpl_end(JNIEnv* env, jobject obj, jlong ctx, jboolean compress) {
    z_stream* stream = (z_stream*) ctx;
...
jlong JNICALL Java_me_nekocloud_core_io_compress_zlib_NativeCompressImpl_init(JNIEnv* env, jobject obj, jboolean compress, jint level) {
...
jint JNICALL Java_me_nekocloud_core_io_compress_zlib_NativeCompressImpl_process(JNIEnv* env, jobject obj, jlong ctx, jlong in, jint inLength, jlong out, jint outLength, jboolean compress) {
    z_stream* stream = (z_stream*) ctx;
